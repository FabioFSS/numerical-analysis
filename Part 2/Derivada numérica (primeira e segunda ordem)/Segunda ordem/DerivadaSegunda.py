...
def DerivadaCentrada(indice, pontosx, pontosy=None, funcao=None):
    if funcao != None:
        res = (funcao(pontosx[indice+1]) - (2*funcao(pontosx[indice])) + funcao(pontosx[indice-1])) / ((pontosx[indice] - pontosx[indice-1])**2)
    else:
        res = (pontosy[indice+1] - (2*pontosy[indice]) + pontosy[indice-1]) / ((pontosx[indice] - pontosx[indice-1])**2)

    return res

def DerivadaRetardada(indice, pontosx, pontosy=None, funcao=None):
    if funcao != None:
        res = (funcao(pontosx[indice]) - (2*funcao(pontosx[indice-1])) + funcao(pontosx[indice-2])) / ((pontosx[indice] - pontosx[indice-1])**2)
    else:
        res = (pontosy[indice] - (2*pontosy[indice-1]) + pontosy[indice-2]) / ((pontosx[indice] - pontosx[indice-1])**2)   

    return res

def DerivadaAvancada(indice, pontosx, pontosy=None, funcao=None):
    if funcao != None:
        res = (funcao(pontosx[indice+2]) - (2*funcao(pontosx[indice+1])) + funcao(pontosx[indice])) / ((pontosx[indice+1] - pontosx[indice])**2)

    else:
        res = (pontosy[indice+2] - (2*pontosy[indice+1]) + pontosy[indice]) / ((pontosx[indice+1] - pontosx[indice])**2)
